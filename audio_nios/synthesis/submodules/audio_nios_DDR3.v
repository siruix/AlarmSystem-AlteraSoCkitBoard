...
// 
// Generated using ACDS version 13.1 162 at 2013.12.14.21:25:44

`timescale 1 ps / 1 ps
module audio_nios_DDR3 (
		...
		output wire         pll_dr_clk,                //                 .pll_dr_clk
		output wire         pll_dr_clk_pre_phy_clk,    //                 .pll_dr_clk_pre_phy_clk
	...
	audio_nios_DDR3_pll0 pll0 (
		...
		.pll_dr_clk                (pll_dr_clk),                //             .pll_dr_clk
		.pll_dr_clk_pre_phy_clk    (pll_dr_clk_pre_phy_clk),    //             .pll_dr_clk_pre_phy_clk
		.pll_mem_phy_clk           (pll_mem_phy_clk),           //             .pll_mem_phy_clk
		.afi_phy_clk               (afi_phy_clk),               //             .afi_phy_clk
		.pll_avl_phy_clk           (pll_avl_phy_clk)            //             .pll_avl_phy_clk
	);

	audio_nios_DDR3_p0 p0 (
		.global_reset_n              (global_reset_n),                              //        global_reset.reset_n
