...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_i2c_sda.v"                       -work i2c_sda               -cdslib ./cds_libs/i2c_sda.cds.lib              
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_i2c_scl.v"                       -work i2c_scl               -cdslib ./cds_libs/i2c_scl.cds.lib              
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_pio_led.v"                       -work pio_led               -cdslib ./cds_libs/pio_led.cds.lib              
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_key.v"                           -work key                   -cdslib ./cds_libs/key.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_jtag_uart.v"                     -work jtag_uart             -cdslib ./cds_libs/jtag_uart.cds.lib            
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu.vo"                          -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu_jtag_debug_module_sysclk.v"  -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu_jtag_debug_module_tck.v"     -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu_jtag_debug_module_wrapper.v" -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu_mult_cell.v"                 -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu_oci_test_bench.v"            -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/audio_nios_cpu_test_bench.v"                -work cpu                   -cdslib ./cds_libs/cpu.cds.lib                  
  ncvlog "$QSYS_SIMDIR/submodules/altera_avalon_mm_clock_crossing_bridge.v"   -work cpu_peripheral_bridge -cdslib ./cds_libs/cpu_peripheral_bridge.cds.lib
  ncvlog "$QSYS_SIMDIR/submodules/altera_avalon_dc_fifo.v"                    -work cpu_peripheral_bridge -cdslib ./cds_libs/cpu_peripheral_bridge.cds.lib
  ncvlog "$QSYS_SIMDIR/submodules/altera_dcfifo_synchronizer_bundle.v"        -work cpu_peripheral_bridge -cdslib ./cds_libs/cpu_peripheral_bridge.cds.lib
  ncvlog "$QSYS_SIMDIR/audio_nios.v"                                                                                                                      
fi
